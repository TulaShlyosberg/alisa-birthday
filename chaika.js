...
async function toast() {
    ...
    switch(this.id) {
        ...
        case 'drinking_3':
            ...
            break;
        case 'drinking_4':
            text = 'Выпьем за путешествия с Алисой! За ванильные утра в Риме и шоколадные ночи в Париже (сорри, очень сложно было удержаться). А также сидровые вечера в Питере и пельменные дни у нее на даче.'
        default:
            break;
    }
    console.log(text);
